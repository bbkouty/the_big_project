...
ActiveRecord::Schema[8.0].define(version: 2025_09_19_124838) do
  ...
  create_table "private_messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id_id"], name: "index_private_messages_on_user_id_id"
  end
  ...
  add_foreign_key "private_messages", "users", column: "user_id_id"
